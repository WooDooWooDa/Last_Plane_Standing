...
{
    [CustomPropertyDrawer(typeof(RangeSharedValueWithFallback), true)]
    public class CustomSharedRangeWithFallbackDrawer : PropertyDrawer
    {
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            valueProp.objectReferenceValue = EditorGUI.ObjectField(fieldRect, valueSo, typeof(RangeSharedValue), false);
